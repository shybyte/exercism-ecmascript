...
test('should locate words written top to bottom simple', () => {
  const grid = [
    "ata",
    "aea",
    "asa",
  ...
  expect(wordSearch.find(["test"])).toEqual(expectedResults);

})


test('should locate words written bottom left to top right simple', () => {
  const grid = [
    "...t",
    "..s.",
    ".e..",
