/* eslint-disable no-mixed-operators,class-methods-use-this */

const MAX_PINS = 10;
const NORMAL_FRAMES_COUNT = 10;

class FrameOpen {
  constructor(pins1, pins2) {
    this.pins1 = pins1;
    this.pins2 = pins2;
  }

  // eslint-disable-next-line no-unused-vars
  needsMoreFillBalls(_fillBalls) {
    return false;
  }
...
function windows(array, windowSize) {
  return array
...
function scoreBowlingGame(rolls) {
  const frames = [];
  let incompleteFrame;
  ...
  function scoreFrameWindow([first, second, third]) {
